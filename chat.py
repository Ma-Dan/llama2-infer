...
model = AutoModelForCausalLM.from_pretrained("../Qwen1.5-1.8B-Chat", trust_remote_code = True)
tokenizer = AutoTokenizer.from_pretrained("../Qwen1.5-1.8B-Chat", legacy=True, trust_remote_code = True)
